...
public class BlockToughRock extends ElementsScapeandRunReinforced.ModElement {
	@GameRegistry.ObjectHolder("srpr_kravataf:toughrock")
	public static final Block block = null;
	public BlockToughRock(ElementsScapeandRunReinforced instance) {
		super(instance, 21);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("srpr_kravataf:toughrock", "inventory"));
	}
