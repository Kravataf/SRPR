...
import net.mcreator.srpr_kravataf.procedure.ProcedureSentientMineExplode;
...
public class BlockSentientMine extends ElementsScapeandRunReinforced.ModElement {
	@GameRegistry.ObjectHolder("srpr_kravataf:sentientmine")
	public static final Block block = null;
	public BlockSentientMine(ElementsScapeandRunReinforced instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("srpr_kravataf:sentientmine", "inventory"));
	}
