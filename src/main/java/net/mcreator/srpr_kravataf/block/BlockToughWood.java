...
public class BlockToughWood extends ElementsScapeandRunReinforced.ModElement {
	@GameRegistry.ObjectHolder("srpr_kravataf:toughwood")
	public static final Block block = null;
	public BlockToughWood(ElementsScapeandRunReinforced instance) {
		super(instance, 22);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("srpr_kravataf:toughwood", "inventory"));
	}
