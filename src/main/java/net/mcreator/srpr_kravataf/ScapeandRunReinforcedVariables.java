package net.mcreator.srpr_kravataf;
...
public class ScapeandRunReinforcedVariables {
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "srpr_kravataf_mapvars";
		public MapVariables() {
			super(DATA_NAME);
		}
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "srpr_kravataf_worldvars";
