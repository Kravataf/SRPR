...
public class ProcedureSentientMineExplode extends ElementsScapeandRunReinforced.ModElement {
	public ProcedureSentientMineExplode(ElementsScapeandRunReinforced instance) {
		super(instance, 2);
	}
