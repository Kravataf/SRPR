...
public class ProcedureDynamiteExplode extends ElementsScapeandRunReinforced.ModElement {
	public ProcedureDynamiteExplode(ElementsScapeandRunReinforced instance) {
		super(instance, 28);
	}
