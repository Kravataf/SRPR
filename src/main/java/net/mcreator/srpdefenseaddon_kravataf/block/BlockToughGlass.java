...
public class BlockToughGlass extends ElementsScapeandRunParasitesDefenseAddon.ModElement {
	@GameRegistry.ObjectHolder("srpdefenseaddon_kravataf:toughglass")
	public static final Block block = null;
	public BlockToughGlass(ElementsScapeandRunParasitesDefenseAddon instance) {
		super(instance, 30);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("srpdefenseaddon_kravataf:toughglass", "inventory"));
	}
