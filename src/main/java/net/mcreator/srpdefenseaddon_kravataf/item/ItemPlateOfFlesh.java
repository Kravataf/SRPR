...
public class ItemPlateOfFlesh extends ElementsScapeandRunParasitesDefenseAddon.ModElement {
	@GameRegistry.ObjectHolder("srpdefenseaddon_kravataf:plateofflesh")
	public static final Item block = null;
	public ItemPlateOfFlesh(ElementsScapeandRunParasitesDefenseAddon instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("srpdefenseaddon_kravataf:plateofflesh", "inventory"));
	}
